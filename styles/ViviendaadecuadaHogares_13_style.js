...
var style_ViviendaadecuadaHogares_13 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("P_V_ADE");
    var labelText = "";
    size = 0;
    ...
    if (value >= 0.000000 && value <= 38.000000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 38.000000 && value <= 68.627451) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 68.627451 && value <= 86.363636) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 86.363636 && value <= 96.226415) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 96.226415 && value <= 100.000000) {
            style = [ new ol.style.Style({
